...
class QdrantConfig(BaseModel):
    ...
    collection_name: str = Field(
        default="anton_agents_vectors", description="向量集合名称"
    )
    ...
    def from_env(cls) -> "QdrantConfig":
        ...
        return cls(
            ...
            collection_name=os.getenv("QDRANT_COLLECTION", "anton_agents_vectors"),
...
class Neo4jConfig(BaseModel):
    ...
    password: str = Field(default="anton-agents-password", description="密码")
    ...
    def from_env(cls) -> "Neo4jConfig":
        ...
        return cls(
            ...
            password=os.getenv("NEO4J_PASSWORD", "anton-agents-password"),
